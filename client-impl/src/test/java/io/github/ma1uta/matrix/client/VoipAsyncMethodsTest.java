...
class VoipAsyncMethodsTest extends MockServer {
    ...
    public void secured() {
        ...
        assertThrows(CompletionException.class, () -> getMatrixClient().turnServersAsync().turnServers().join());
    }
    ...
    public void voip() {
        ...
        VoipResponse voip = getMatrixClient().turnServersAsync().turnServers().join();
        assertNotNull(voip);
