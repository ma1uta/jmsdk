...
class ClientConfigAsyncMethodsTest extends MockServer {
    ...
    void addConfig(boolean withToken) throws Exception {
        ...
        EmptyResponse emptyResponse = getMatrixClient().clientConfigAsync().addConfig("org.example.custom.config", config)
    ...
    void addRoomConfig(boolean withToken) throws Exception {
        ...
        Map<String, Object> config = new HashMap<>();
        config.put("custom_account_data_key", "custom_config_value");
        EmptyResponse emptyResponse = getMatrixClient().clientConfigAsync()
