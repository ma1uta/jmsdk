...
import io.github.ma1uta.matrix.client.rest.blocked.ReportApi;
...
public class ReportMethods {
     ...
     */
    public EmptyResponse report(String roomId, String eventId, String reason, Integer score) {
        ...
        return reportApi.report(roomId, eventId, request);
    }
}
