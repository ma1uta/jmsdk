...
public interface DeviceApi {
    ...
    @GET
    @Path("/devices")
    CompletionStage<DevicesResponse> devices();
    ...
    @PUT
    @Path("/devices/{deviceId}")
    CompletionStage<EmptyResponse> updateDevice(
        @PathParam("deviceId") String deviceId,
    ...
    @DELETE
    @Path("/devices/{deviceId}")
    CompletionStage<EmptyResponse> deleteDevice(
        @PathParam("deviceId") String deviceId,
    ...
    @POST
    @Path("/delete_devices")
    CompletionStage<EmptyResponse> deleteDevices(
