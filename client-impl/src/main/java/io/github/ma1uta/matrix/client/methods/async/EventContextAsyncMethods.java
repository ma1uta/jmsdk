...
import io.github.ma1uta.matrix.client.rest.async.EventContextApi;
 ...
 */
public class EventContextAsyncMethods {

    private final EventContextApi eventContextApi;

    public EventContextAsyncMethods(RestClientBuilder restClientBuilder) {
