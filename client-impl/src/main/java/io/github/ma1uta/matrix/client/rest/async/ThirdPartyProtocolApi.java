...
public interface ThirdPartyProtocolApi {
    ...
    @GET
    @Path("/protocols")
    CompletionStage<Map<String, Protocol>> protocols();
    ...
    CompletionStage<Protocol> protocol(
    ...
    CompletionStage<List<ProtocolLocation>> locationProtocol(
        @PathParam("protocol") String protocol
    );
    ...
    @GET
    @Path("/user/{protocol}")
    CompletionStage<List<ProtocolUser>> userProtocol(
        @PathParam("protocol") String protocol
    );
    ...
    @GET
    @Path("/location")
    CompletionStage<List<ProtocolLocation>> location(
    ...
    @GET
    @Path("/user")
    CompletionStage<List<ProtocolUser>> user(
