...
public interface ProfileApi {
    ...
    CompletionStage<EmptyResponse> setDisplayName(
    ...
    @GET
    @Path("/{userId}/displayname")
    CompletionStage<DisplayName> showDisplayName(
        @PathParam("userId") String userId
    );
    ...
    CompletionStage<EmptyResponse> setAvatarUrl(
        @PathParam("userId") String userId,
        AvatarUrl avatarUrl
    );
    ...
    @GET
    @Path("/{userId}/avatar_url")
    CompletionStage<AvatarUrl> showAvatarUrl(
        @PathParam("userId") String userId
    );
    ...
    @GET
    @Path("/{userId}")
    CompletionStage<Profile> profile(
        @PathParam("userId") String userId
    );
}
