...
public interface EventApi {
    ...
    CompletionStage<Event> roomEvent(
    ...
    CompletionStage<byte[]> roomEventWithTypeAndState(
        @PathParam("roomId") String roomId,
    ...
    @GET
    @Path("/{roomId}/state")
    CompletionStage<List<Event>> roomState(
        @PathParam("roomId") String roomId
    );
    ...
    @GET
    @Path("/{roomId}/members")
    CompletionStage<MembersResponse> members(
        @PathParam("roomId") String roomId
    );
    ...
    CompletionStage<JoinedMembersResponse> joinedMembers(
        @PathParam("roomId") String roomId
    );
    ...
    CompletionStage<Page<Event>> messages(
        @PathParam("roomId") String roomId,
    ...
    @PUT
    @Path("/{roomId}/state/{eventType}/{stateKey}")
    CompletionStage<SendEventResponse> sendStateEvent(
        @PathParam("roomId") String roomId,
        @PathParam("eventType") String eventType,
        @PathParam("stateKey") String stateKey,
        EventContent event
    ...
    CompletionStage<SendEventResponse> sendEvent(
        @PathParam("roomId") String roomId,
        @PathParam("eventType") String eventType,
    ...
    CompletionStage<SendEventResponse> redact(
        @PathParam("roomId") String roomId,
        @PathParam("eventId") String eventId,
        @PathParam("txnId") String txnId,
        RedactRequest event
