...
import io.github.ma1uta.matrix.client.rest.async.OpenIdApi;
 ...
 * OpenID methods.
 */
public class OpenIdAsyncMethods {

    private final OpenIdApi openIdApi;
    private final ConnectionInfo connectionInfo;

    public OpenIdAsyncMethods(RestClientBuilder restClientBuilder, ConnectionInfo connectionInfo) {
     ...
     * @return OpenID token.
     */
    public CompletableFuture<OpenIdResponse> requestToken() {
        return openIdApi.requestToken(connectionInfo.getUserId()).toCompletableFuture();
    }
}
