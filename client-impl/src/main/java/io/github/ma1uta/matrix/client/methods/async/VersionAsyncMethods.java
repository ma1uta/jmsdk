...
import io.github.ma1uta.matrix.client.rest.async.VersionApi;
 ...
 * Version methods.
 */
public class VersionAsyncMethods {

    private final VersionApi versionApi;

    public VersionAsyncMethods(RestClientBuilder restClientBuilder) {
