...
import io.github.ma1uta.matrix.client.rest.blocked.TypingApi;
...
public class TypingMethods {
     ...
     */
    public EmptyResponse typing(String roomId, Boolean typing, Long timeout) {
        ...
        return typingApi.typing(roomId, userId, request);
    }
}
