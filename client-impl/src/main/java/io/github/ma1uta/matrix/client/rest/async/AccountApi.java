...
public interface AccountApi {
    ...
    CompletionStage<DeactivateResponse> deactivate(
    ...
    CompletionStage<AvailableResponse> available(
    ...
    @POST
    @Path("/account/3pid")
    CompletionStage<EmptyResponse> updateThreePid(
    ...
    CompletionStage<DeactivateResponse> deleteThreePid(
    ...
    CompletionStage<SessionResponse> threePidEmailRequestToken(
        EmailRequestToken requestToken
    );
    ...
    CompletionStage<SessionResponse> threePidMsisdnRequestToken(
        MsisdnRequestToken requestToken
    );
    ...
    @GET
    @Path("/account/whoami")
    CompletionStage<WhoamiResponse> whoami();
}
