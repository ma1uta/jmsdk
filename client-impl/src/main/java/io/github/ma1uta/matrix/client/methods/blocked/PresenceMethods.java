...
public class PresenceMethods {
     ...
     */
    public EmptyResponse setPresenceStatus(String presence, String status) {
        ...
        return presenceApi.setPresenceStatus(userId, request);
    }
    ...
    public PresenceStatus getPresenceStatus(String userId) {
        ...
        return presenceApi.getPresenceStatus(userId);
    }
}
