...
import io.github.ma1uta.matrix.client.rest.blocked.EncryptionApi;
...
public class EncryptionMethods {
    ...
    public UploadResponse uploadKey(UploadRequest request) {
        return encryptionApi.uploadKey(request);
    }
    ...
    public QueryResponse query(QueryRequest request) {
        ...
        return encryptionApi.query(request);
    }
    ...
    public ClaimResponse claim(ClaimRequest request) {
        ...
        return encryptionApi.claim(request);
    }
    ...
    public ChangesResponse changes(String from, String to) {
        ...
        return encryptionApi.changes(from, to);
    }
}
